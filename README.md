This code enables one to control a Thorlabs KCube DC motor to move a translation stage automatically. Takes an image using an ICimage camera after each movement by the translation stage.
